...
export default createEslintRule({
  ...
  create(context) {
    ...
    let firstExtraStatement: ASTNode;
 ...
 */
    function getActualLastToken(node: ASTNode): ASTToken {
 ...
 * @returns {void}
 */
    function enterStatement(node: ASTNode): void {
     ...
     */
      if (SINGLE_CHILD_ALLOWED.test(node.parent.type)
        && (node.parent as ASTNode).alternate !== node
      ) {
        return;
      }
 ...
 * @returns {void}
 */
    function leaveStatement(node: ASTNode): void {
